...
*/
#define PATH_LOADSEARCH "/usr/local/share/emacs/29.0.60/lisp"

/* Like PATH_LOADSEARCH, but contains the relative path from the
   installation directory.
*/
#define PATH_REL_LOADSEARCH "29.0.60/lisp"
...
*/
#define PATH_SITELOADSEARCH "/usr/local/share/emacs/29.0.60/site-lisp:/usr/local/share/emacs/site-lisp"
...
*/
#define PATH_DUMPLOADSEARCH "/home/saunders/projects/the-livingroom/sys-config/repos/emacs-builder/build.d/../emacs.git/lisp"
...
#define PATH_EXEC "/usr/local/libexec/emacs/29.0.60/x86_64-pc-linux-gnu"

/* Where Emacs should look for its architecture-independent data
   files, like the NEWS file.  The lisp variable data-directory
   is set to this value.  */
#define PATH_DATA "/usr/local/share/emacs/29.0.60/etc"
...
#define PATH_DOC "/usr/local/share/emacs/29.0.60/etc"
