...
#define EMACS_CONFIG_FEATURES "CAIRO DBUS FREETYPE GIF GLIB GMP GNUTLS GPM GSETTINGS HARFBUZZ JPEG JSON LIBOTF LIBSELINUX LIBXML2 M17N_FLT MODULES NATIVE_COMP NOTIFY INOTIFY PDUMPER PNG RSVG SECCOMP SOUND SQLITE3 THREADS TIFF TOOLKIT_SCROLL_BARS X11 XDBE XIM XINPUT2 XPM GTK3 ZLIB"

/* Define to the options passed to configure. */
#define EMACS_CONFIG_OPTIONS "--with-cairo --with-file-notification=inotify --with-gconf --with-gif --with-jpeg --with-json --with-lcms2 --with-libsystemd --with-native-compilation --with-png --with-rsvg --with-tiff --with-xml2 --with-dbus --with-libotf --with-modules --with-x-toolkit=gtk3 --without-ns --without-compress-install --with-gnutls 'CFLAGS=-O3 -mtune=native -march=native -fomit-frame-pointer'"
...
#define PACKAGE_STRING "GNU Emacs 29.0.60"
...
#define PACKAGE_VERSION "29.0.60"
